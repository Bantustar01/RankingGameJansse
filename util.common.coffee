...
exports.questions = -> [
	...
	["haat de Quran het meeste", false]
	["Zou als eerste naar Syrie vertrekken", false]
	["heeft enkele gay trekjes", false]
	["valt op de lelijkste wijven", false]
	["is het lelijkste", false]
	["is de dikste matennaaier", false]
	["is oprecht fan van Hitler", false]
	["gaat waarschijnlijk nooit ontmaagd worden", false]
	["houdt van penissen in zijn aars", false]
	["rukt op zijn eigen moeder", false]
	["heeft de lekkerse zus", false]
	["heeft de meeste kans om Marie Bertands te krijgen", false]
	["moet giel het meest", false]
	["is de leukste", false]
	["heeft de dikste kaasrand", false]
	["heeft het laagste IQ", false]
	["doet alsof hij turken haat maar haat ze niet echt", false]
